...
module perpetual_trading::perpetual_manager {
    // === Imports ===
    use std::signer;
    use std::string;
    use std::error;
    ...
    ) acquires UserPositions, UserPositionCollaterals, Market {
    ...
    fun open_position_internal<CollateralCoin>(
        ...
        let market = borrow_global_mut<Market<CollateralCoin>>(market_addr);
